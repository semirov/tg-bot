...
- **Помнит беседу за сутки**, различает авторов по имени и id и не продолжает старую
  тему после длинной паузы;
...
- Реплики чатов для контекста модели (текст, автор, роль, время)
- Хранится 24 часа, медиа и ссылки — только пометками типа
...
Логи пишутся без текста сообщений и ответов тролль-бота — только действия, ожидания и ошибки.
