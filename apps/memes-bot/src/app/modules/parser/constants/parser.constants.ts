...
/**
 * Порог схожести «уже опубликовано» для дедупликации парсера.
 *
 * 0.85 соответствует классическому порогу Хамминга ~10 бит из 256 для
 * блок-хеша 16x16: ниже этого уровня ложные срабатывания на мемы с
 * однотонными фонами превышают реальные дубликаты (случайная пара даёт
 * ~0.48 совпадения битов).
 */
